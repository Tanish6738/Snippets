...
import { FiFolder, FiCode, FiTag, FiX, FiLock, FiGlobe, FiShare2, FiType, FiAlignLeft, FiSave, FiEye } from 'react-icons/fi';
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <FiFolder className="absolute left-3.5 top-3.5 text-slate-500" />
                </div>
              </div>
