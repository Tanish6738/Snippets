...
const VelocityText = ({ 
  ...
  velocityRange = [0.005, 0.0075], // Slower velocity range
  skewRange = ["5deg", "-5deg"], // Reduced skew range for subtle effect
  xRange = [0, -500], // Reduced xRange for slower movement
